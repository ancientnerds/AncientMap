...
-- the reversal of 2 site_external_ids row(s); run stamp '2026-09-23_external-id-repair-wave3-rollback'.
...
BEGIN
    ...
    FOR r IN SELECT * FROM _ext_plan ORDER BY site_id, kind LOOP
        ...
        VALUES ('2026-09-23_external-id-repair-wave3-rollback', r.test_id, 'site_external_ids', 'value',
    ...
    SELECT count(*) INTO bad FROM _ext_plan p LEFT JOIN remediation_change_log l
        ON l.run_stamp = '2026-09-23_external-id-repair-wave3-rollback' AND l.change_key = p.change_key
    ...
    SELECT count(*) INTO bad FROM remediation_change_log l
     WHERE l.run_stamp = '2026-09-23_external-id-repair-wave3-rollback'
...
SELECT 'journal rows for this stamp' AS metric, count(*)::text AS value
  FROM remediation_change_log WHERE run_stamp = '2026-09-23_external-id-repair-wave3-rollback';

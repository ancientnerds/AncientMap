...
def create_public_api() -> FastAPI:
    ...
    public_app = FastAPI(
        ...
        description=(
            ...
            "requirement.\n\n"
            "All news, article, and research content on this API is AI-generated "
            "and carries machine-readable `ai_generated` / `ai_system` fields "
            "(Art. 50 EU AI Act)."
        ),
        version="1.2.0",
        docs_url="/docs",
    ...
    @public_app.get(
        ...
        description=(
            ...
            "AI-generated by the **Theo research pipeline** and published after "
            "automated quality and citation checks.\n\n"

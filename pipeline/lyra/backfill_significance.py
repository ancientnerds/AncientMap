...
HIGH_KEYWORDS = {
    ...
    9: [
        r"new(?:ly)?.(?:found|discover)",
        r"first.(?:ever|of.its.kind)",
        r"unknown.chamber",
        r"never.before.seen",
        r"first.time.ever",
        r"brand.new.site",
    ...
    8: [
        r"dna.(?:results?|analysis|reveal)",
        r"major.dat(?:e|ing).revision",
        r"breakthrough",
        r"isotop(?:e|ic).analysis",
        r"radiocarbon.(?:dates?|results?)",
    ],
    7: [
        r"(?:important|major|remarkable).(?:artifact|find|discovery|tomb|structure)",
        r"intact.tomb",
        r"royal.burial",
        r"treasure",
        r"golden",
...
MEDIUM_KEYWORDS = {
    6: [
        r"(?:new|recent|published).(?:study|research|paper)",
        r"peer.review",
        r"reinterpret",
        r"new.interpretation",
    ],
    5: [
        r"excavation.progress",
        r"restoration.complet",
        r"significant.update",
...
CATEGORY_PATTERNS: list[tuple[str, list[str]]] = [
    (
        "bioarchaeology",
        [r"dna", r"isotop", r"skeleton", r"burial", r"remains", r"ancient.human", r"diet.analys"],
    ),
    (
        "dating",
        [
    ...
    (
        "epigraphy",
        [r"inscription", r"decipher", r"hieroglyph", r"cuneiform", r"script", r"text.analys"],
    ),
    ...
    (
        "theory",
        [r"reinterpret", r"alternative.hypothes", r"debate", r"theor(?:y|ies)", r"controver"],
    ),

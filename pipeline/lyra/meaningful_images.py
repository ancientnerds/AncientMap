...
STRICT_VLM_PROMPT = (
    ...
    "SUBJECT, NOT INSTANCE. Many claims are statistical, theoretical or "
    "quantitative ('2,889 superflares across 56,450 observed stars'). No photograph "
    "depicts a statistic. Judge the image against the SUBJECT MATTER of the claim, "
    "not against its numbers: an authentic image of the phenomenon, instrument, "
    "place, organism or process under discussion is 'meaningful' even when it is not "
    "the specific instance measured. A real photograph of a solar flare IS a literal "
    "depiction of solar flares. Scientific figures, observatory imagery, instrument "
    "photographs and data visualisations from the field in question count as literal "
    "depictions of what they show.\n\n"
    "USE THE MIDDLE VERDICT. 'weak' means the image is honestly related to the "
    "passage but is not a depiction of its primary subject — it will be published as "
    "an illustration and labelled as one, so it does not need to prove the claim. "
    "Reserve 'misleading' for images that would leave a reader with a FALSE belief "
    "about the subject. Do not use 'misleading' merely because a picture is generic.\n\n"

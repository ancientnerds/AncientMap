...
class RockArtIngester(BaseIngester):
    ...
    ROCK_ART_SITES = [
        ...
        {
            "name": "Drakensberg Cave Paintings",
            "lat": -29.4167,
            "lon": 29.4167,
            "type": "rock_painting",

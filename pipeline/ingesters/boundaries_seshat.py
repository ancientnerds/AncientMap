...
class SeshatIngester(BaseIngester):
    ...
    def fetch(self) -> Path:
        ...
        self.report_progress(
            len(all_polities), len(all_polities), f"{len(all_polities):,} polities"
        )
    ...
    def _parse_polity_row(self, row: dict) -> dict | None:
        ...
        return {
            ...
            "territory_km2": self._parse_float(
                row.get("Polity Territory", row.get("territory_km2", ""))
            ),
            "population": self._parse_int(
                row.get("Population", row.get("population_estimate", ""))
            ),
    ...
    def _get_known_polities(self) -> list[dict]:
        ...
        return [
            ...
            {
                "id": "seshat_athenian_empire",
                "name": "Athenian Empire",
                "nga": "Attica",
                "start_year": -478,
                "end_year": -404,
                "polity_type": "hegemony",
                "capital": "Athens",
            },
            {
                "id": "seshat_macedon_philip",
                "name": "Macedonian Kingdom (Philip II)",
                "nga": "Konya Plain",
                "start_year": -359,
                "end_year": -336,
                "polity_type": "kingdom",
            ...
            # Mesoamerica
            {
                "id": "seshat_teotihuacan",
                "name": "Teotihuacan",
                "nga": "Valley of Oaxaca",
                "start_year": -100,
                "end_year": 550,
                "polity_type": "city-state",
                "capital": "Teotihuacan",
            },
            {
                "id": "seshat_maya_tikal",
                "name": "Tikal (Classic Maya)",
                "nga": "Peten",
                "start_year": 250,
                "end_year": 900,
                "polity_type": "city-state",

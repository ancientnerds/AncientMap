...
PHASE4_SOURCES_MUTATIONS: list[tuple[str, str, str, str, str, str]] = [
    ...
    (
        ...
        "        refusal = None  # mutant\n",
        P4_ROUTES_TEST,
        "test_a_quota_gate_refusal_holds_the_site_and_stops_the_run",
    ),
    (
    ...
    (
        "p4 route_stage: a stopped search still gets a lane",
        P4_ROUTES,
    ...
    (
        "p4 route_stage: a wiki outage in S1b is decided on",
        P4_ROUTES,
    ...
    (
        "p4 plan4: pair names are not folded",
        P4_PLAN,

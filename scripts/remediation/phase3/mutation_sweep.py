...
SITELINK_MUTATIONS: list[tuple[str, str, str, str, str, str]] = [
    ...
    (
        ...
        "    if flagged is not None and flagged[0] == kept:  # mutant\n",
        _SLP_TEST,
    ...
    (
        ...
        _SLP,
        "    if flagged is not None and flagged[0] == kept and site_id not in LINK_RIGHT:\n",
        "    if flagged is not None and site_id not in LINK_RIGHT:  # mutant\n",
        _SLP_TEST,
    ...
    (
        "sitelink: a suspicion without the judged item is kept",
        _SLP,

...
Creates two collections with named vectors:
...
def index_sites(client: QdrantClient, embeddings, sparse_model, rebuild: bool = False):
    ...
    sql = """
        SELECT us.id::text, us.name, us.site_type, us.period_name, us.period_start,
               us.country, us.description, us.lat, us.lon, us.raw_data,
...
def main():
    ...
    parser.add_argument("--collection", choices=["sites", "news"], help="Only index this collection")

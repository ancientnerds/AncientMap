  ...
  const renderSourceBadge = () => {
    ...
    return (
      <div className="source-switcher-wrap" ref={dropdownRef}>
        <div
          className={`popup-source clickable source-switcher-trigger ${dropdownOpen ? 'open' : ''}`}
        ...
        >
          ...
          <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="source-switcher-chevron">
            <polyline points="6 9 12 15 18 9"></polyline>
          </svg>
        </div>

        {dropdownOpen && (
          <div className="source-switcher-dropdown" onMouseDown={(e) => e.stopPropagation()}>

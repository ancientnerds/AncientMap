      ...
      <div className="lyra-poster-body">
        ...
        <div className="lyra-poster-center">
          ...
          <div className="lyra-poster-section">
            ...
            <a className="lyra-poster-discord" href={discordCtaUrl('lyra')} target="_blank" rel="noopener noreferrer">
        ...
        <div className="lyra-poster-right">
          ...
          <div className="lyra-poster-optout">
            ...
            <div className="lyra-poster-optout-links">
              ...
              <a href={discordCtaUrl('lyra')} target="_blank" rel="noopener noreferrer">

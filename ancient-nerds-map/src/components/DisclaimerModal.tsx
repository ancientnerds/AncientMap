      ...
      <div className="disclaimer-modal" onClick={e => e.stopPropagation()}>
        ...
        <div className="disclaimer-content">
          ...
          <Section title="AI-Generated Content">
            <p>News feed items are <strong>automatically generated by AI</strong> (Claude Haiku 4.5) from publicly available YouTube video transcripts. The AI extracts archaeological facts and presents them in summary form.</p>
            <ul>
              ...
              <li>Summaries may contain errors or misinterpretations of the source material.</li>
            </ul>

            <h4>YouTube Creator Opt-Out</h4>
            <p>If you are a YouTube creator and would like your channel excluded from our news pipeline, please email <a href="mailto:ancient.nerds@protonmail.com?subject=Channel%20Opt-Out">ancient.nerds@protonmail.com</a> with the subject "Channel Opt-Out" and your channel name or URL. We will remove your channel within 7 days.</p>
          </Section>

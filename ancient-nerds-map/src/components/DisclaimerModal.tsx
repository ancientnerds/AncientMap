        ...
        <div className="disclaimer-content">
          ...
          <Section title="Data Sources & Attribution" defaultOpen={true}>
            ...
            <p className="attribution-note">
              We gratefully acknowledge all data providers and contributors. If you believe any attribution is missing or incorrect, please reach out:
            </p>
          ...
          <Section title="AI-Generated Content">
            ...
            <p>If you are a YouTube creator and would like your channel excluded from our news pipeline, reach out with the subject "Channel Opt-Out" and your channel name or URL. We will remove your channel within 7 days.</p>
            <div className="contact-links">

...
export const NEWS_LAYOUT: HexLayoutConfig = {
  ...
  nodes: [
    // Row 0 — left to right
    { id: 'fetch', label: 'Fetch', icon: '\u21E3', dataType: 'db', stepNumber: '01', position: { left: 112, top: 0 } },
    { id: 'retry', label: 'Retry', icon: '\u27F3', dataType: 'db', stepNumber: '02', position: { left: 224, top: 0 } },
    { id: 'summarize', label: 'Summarize', icon: '\u03A3', dataType: 'llm', stepNumber: '03', position: { left: 336, top: 0 } },
    // Row 1 — right to left (staggered)
    { id: 'match', label: 'Match', icon: '\u25CE', dataType: 'db', stepNumber: '04', position: { left: 280, top: 98 } },
    { id: 'posts', label: 'Posts', icon: '\u2B21', dataType: 'llm', stepNumber: '05', position: { left: 168, top: 98 } },
    { id: 'verify', label: 'Verify', icon: '\u2727', dataType: 'llm', stepNumber: '06', position: { left: 56, top: 98 } },
    // Row 2 — left to right
    { id: 'rescore', label: 'Rescore', icon: '\u21C5', dataType: 'db', stepNumber: '07', position: { left: 0, top: 196 } },
    { id: 'dedup', label: 'Dedup', icon: '\u2298', dataType: 'db', stepNumber: '08', position: { left: 112, top: 196 } },
...
export const ARTICLE_LAYOUT: HexLayoutConfig = {
  ...
  nodes: [
    { id: 'collect', label: 'Collect', icon: '\u21E3', dataType: 'db', stepNumber: '01', position: { left: 112, top: 0 } },
    { id: 'write', label: 'Write', icon: '\u270E', dataType: 'llm', stepNumber: '02', position: { left: 56, top: 98 } },
    { id: 'verify', label: 'Verify', icon: '\u2727', dataType: 'llm', stepNumber: '03', position: { left: 168, top: 98 } },
    { id: 'polish', label: 'Polish', icon: '\u25C7', dataType: 'llm', stepNumber: '04', position: { left: 0, top: 196 } },
    { id: 'headline', label: 'Headline', icon: 'H', dataType: 'llm', stepNumber: '05', position: { left: 112, top: 196 } },
  ],
};
